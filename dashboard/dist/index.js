        ...
        : h("div", { style: { display: "grid", gap: "0.4rem" } }, visible.map(function (session, i) {
          ...
          return h("div", { key: key, className: "brf-card", style: {
            ...
            h("div", { style: { display: "flex", alignItems: "center", gap: "0.45rem" } },
              h("button", { type: "button", className: "brf-session-action brf-session-disclosure", onClick: function () { toggle(session, key); }, "aria-expanded": open, "aria-label": (open ? "Collapse" : "Expand") + " session details", style: { color: "inherit" } }, open ? "⌄" : "›"),
              ...
              session.id ? h("button", { type: "button", className: "brf-session-action", onClick: function () { rename(session); }, title: "Rename session", "aria-label": "Rename session", style: { color: "inherit" } }, "✎") : null,
              session.id ? h("button", { type: "button", className: "brf-session-action", onClick: function () { download(session); }, title: "Export JSON", "aria-label": "Export session as JSON", style: { color: "inherit" } }, "↓") : null,
              session.id ? h("button", { type: "button", className: "brf-session-action brf-session-action-danger", onClick: function () { remove(session, key); }, title: "Delete session", "aria-label": "Delete session" }, "×") : null),
